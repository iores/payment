...
public class UserLoginDto extends UuidBaseDto {
    ...
    public String getHandlerBatchNo() {
        return handlerBatchNo;
    }

    public void setHandlerBatchNo(String handlerBatchNo) {
        this.handlerBatchNo = handlerBatchNo;
    }
}